...
######################配置信息##########################
# m3u8链接批量输入文件
m3u8InputFilePath = "C:/workspace/pythonProject/zhonghang_yingbaing_huilv_pachong/test/input/m3u8s_input.txt"
# 视频保存路径
saveRootDirPath = "C:/workspace/pythonProject/zhonghang_yingbaing_huilv_pachong/test/output"
# 下载出错的m3u8保存文件
errorM3u8InfoDirPath = "C:/workspace/pythonProject/zhonghang_yingbaing_huilv_pachong/test/output/error.txt"
